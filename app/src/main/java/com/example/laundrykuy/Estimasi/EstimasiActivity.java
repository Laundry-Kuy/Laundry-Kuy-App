...
public class EstimasiActivity extends AppCompatActivity {
    private Button btn_berat,btn_simpan;
...
private TextView txt_kaos,txt_jeans,txt_kemeja,txt_celanabahan,txt_celanapendek,txt_sarung,txt_kaoskaki,txt_sweater,txt_daster,txt_rok, txt_hasil,txt_harga,tv_kg,tv_rupiah;
private int nilai = 0;
...
private String kg,Uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_kg = findViewById(R.id.textView4);
        tv_rupiah = findViewById(R.id.textView7);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.profile:
                        Intent intent2 = new Intent(EstimasiActivity.this, ProfileActivity.class);
                        intent2.putExtra("Uid", Uid);
                        startActivity(intent2);
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.home:
                        Intent intent = new Intent(EstimasiActivity.this, MenuActivity.class);
                        intent.putExtra("Uid", Uid);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.status:
                        Intent intent1 = new Intent(EstimasiActivity.this, StatusActivity.class);
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("berat", txt_hasil.getText().toString()+"  Kilogram");
                bundle.putString("harga", txt_harga.getText().toString()+"  Rupiah");

                Intent intent = new Intent(EstimasiActivity.this, MenuMencuci.class);
                Toast.makeText(EstimasiActivity.this,"Estimasi Berat Pakaian Adalah "+  txt_hasil.getText() + "Kilogram"+"Dengan Estimasi Harga"+ txt_harga.getText()+ "Rupiah", Toast.LENGTH_SHORT).show();
